            ...
            <View style={styles.Videocontainer}>
                ...
                <View style = {styles.bottomView}>
                    ...
                    <View style = {styles.SendPost}>
                        <Feather name = "send" size={30} color = "rgb(248, 248, 242)"/>
                    </View>
                    ...
                    <View style = {styles.ContentPost}>
                        <View style = {styles.ContentPostLeft}>
                            ...
                            <View style = {{flexDirection : 'row'}}>
                                <Text style = {styles.PostText}>{item.namemusic} <Entypo name="dot-single" size={15} color = "white"/> {item.singer}</Text>
                                <Feather name="user" size={15} color = "white" style = {{marginLeft : '2%', marginTop : '5%'}}/>
