...
export default function FollowerOnWaiter() {
    const navigation = useNavigation();
    return(
        <View style = {styles.FollowerOnWaiter}>
            {/* Header Message Control */}
            <View style = {styles.HeaderFollowerOnWaiter}>
                <AntDesign name = "arrowleft" size={25} color = "rgb(248, 248, 242)" style ={styles.IconBack} onPress = {(e) =>{navigation.goBack()}}></AntDesign>
                <Text style = {styles.textFollowerOnWaiter}>Your followers on Waiter</Text>
            </View>
            {/* Title */}
            <Text style = {styles.textTitleFollowerOnWaiter}>Deliver request to</Text>
...
const styles = StyleSheet.create({
    ...
    HeaderFollowerOnWaiter: {
        flexDirection: 'row',
        height: 40,
    },
    textFollowerOnWaiter: {
        fontSize: 22,
        marginLeft: 25,
        marginTop: 8,
